...
| **Adversarial review** | Готовый ADR / Solution Design / proposal — жёсткий разбор по 8 осям с severity |
| **Compliance & target check** | Структурированный аудит соответствия 152-ФЗ, 115-ФЗ, PCI DSS, GDPR и target arch |
| **Reuse & landscape discovery** | Найти в ландшафте банка то, что уже решает задачу, до начала нового строительства |
| **Draft architectural artifact** | Создать ADR, Solution Design или ARB-пакет — с нуля или по идее |
